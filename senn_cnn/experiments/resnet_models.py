...
from senn.neural import HPerturb
import wandb
...
class ResNetBlock(nn.Module):
    ...
    def __call__(
        ...
        return HPerturb(self.act)(residual + y)
...
class ResNet(nn.Module):
    ...
    def __call__(self, x, train: bool = True):
        train = self.is_mutable_collection("batch_stats")
        ...
        x = nn.Dense(self.num_classes, dtype=self.dtype, use_bias=False)(x)
