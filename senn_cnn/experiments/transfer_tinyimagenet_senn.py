...
def main():
    ...
    wandb.config.freeze_thresh = 0.0
    wandb.config.thaw_thresh = 0.0
    wandb.config.freeze_thresh_rel = 1e-4
    wandb.config.thaw_thresh_rel = 1e-4
    ...
    wandb.config.add_width_thresh = 0.2
    wandb.config.add_width_factor = 0.2
    ...
    wandb.config.load_as_init = CHECKPOINT_DIR 
